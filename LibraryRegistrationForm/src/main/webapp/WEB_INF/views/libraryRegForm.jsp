		...
		<div class="tab-content">
			<div id="home" class="tab-pane fade in active">
				...
				<span class="text-danger">*</span> indicates mandatory fields
					...
					<form action="./saveDetails" method="post" enctype="multipart/form-data" onsubmit="return FormValidation()">


						<h3 class="display-4 text-danger" align="center">Library Registration Form</h3>
						...
						<div class="row">
							<div class="form-group col-md-4">
								<label>Library Name :<span
						class="text-danger">*</span></label> <select
									onchange="library_subscription()" id="libraryId" name="lName"
									class="form-control">
							...
							<div class="form-group col-md-4">
								<label>Subscription Type:<span
						class="text-danger">*</span></label> <select
									onchange="subscription_cost()" id="subscriptionId" name="sName"
									class="form-control">
									<option value="0">-select-</option>
							...
							<div class="form-group col-md-4">
								<label>Subscription Fees:<span
						class="text-danger">*</span></label> <input disabled="disabled"
									type="text" name="subscriptionCost" id="costId"
									class="form-control">
							</div>
						</div>
						<div class="container"
			...
			<div id="menu1" class="tab-pane fade">
				<h2 class="display-4 text-danger" align="center" id="h3">Registration Details</h2>
			...
			<tbody>
				...
				<c:forEach items="${allBookingList}" var="library" varStatus="count">
				<tr>
					<td>${count.count}</td>
