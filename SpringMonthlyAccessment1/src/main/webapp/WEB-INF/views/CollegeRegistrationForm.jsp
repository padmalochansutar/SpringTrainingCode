			...
			<div id="home" class="tab-pane fade in active">
				...
				<span class="text-danger">*</span> indicates mandatory fields
					...
					<form action="./saveData" method="post" enctype="multipart/form-data" onsubmit="return FormValidation()">
						...
						<h3 class="display-4 text-danger" align="center">College Registration Form</h3>
						...
						class="text-danger">*</span></label> <select
									onchange="college()" id="collegeId" name="cName"
									class="form-control">
						...
						class="text-danger">*</span></label> <select
							...
							<div class="form-group col-md-4">
								<label>Admission Fees:<span
						class="text-danger">*</span></label> <input disabled="disabled"
									type="text" name="subscriptionCost" id="feesId"
									class="form-control">
							</div>
						</div>
						<div class="container"
